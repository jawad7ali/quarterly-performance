...
<div class="user-info">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-3">
      <input type="text" name="user_joining_date" class="form-control datepicker" placeholder="Enter Joining Date" value="<?php echo date("Y-m-d",strtotime(@$selected_factors_list[0]['mtl_joining_date'])); ?>"  required autofocus>
    </div>
    <div class="col-md-3">
      <label for="evaluation_quarter" class="form-control col-form-label" >Quarter:</label>
    </div>
    <div class="col-md-3">
      <input type="text" name="evaluation_quarter" class="form-control" placeholder="Enter Quarter" value="<?php echo @$selected_factors_list[0]['mtl_quarter']; ?>" required autofocus>
    </div>
  </div>
  <div class="form-group row">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
      <input type="text" name="user_project" class="form-control" placeholder="Enter Module" value="<?php echo @$selected_factors_list[0]['mtl_project']; ?>" required autofocus>
    </div>
    <div class="col-md-3">
...
<table class="table table-bordered table-inverse factors-table">
    ...
    <tbody>
      ...
      <?php $i=1; foreach ($selected_factors_list as $key => $value): ?>
        ...
        <tr>
          <td><?php echo $i; ?></td>
          <td class="factor-description"><?php echo '<b>'.$value['mtl_cat_name'].' : </b>'.$value['mtl_eval_description']; ?></td>
