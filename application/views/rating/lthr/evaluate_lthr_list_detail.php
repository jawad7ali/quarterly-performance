...
<div class="user-info">
	...
	<div class="form-group row">
		...
		<div class="col-md-3">
			<div class="form-control">
				<?php echo date("Y-m-d",strtotime($evaluate_list_detail[0]['tlhr_joining_date'])); ?>
			</div>
		</div>
		<div class="col-md-3">
	...
	<div class="form-group row">
		...
		<div class="col-md-3">
			<div class="form-control">
				<?php echo date("Y-m-d",strtotime($evaluate_list_detail[0]['tlhr_date'])); ?>
			</div>
		</div>
	</div>
                ...
                <div class="row decision">
                    ...
                    <div class="col-xs-12 col-sm-6 options btn-group" data-toggle="buttons" role="group" aria-label="Options">
                        <label class="btn btn-default option agree max <?php if(@$tlhr_rating_number== 3){echo $active_class;} ?>" >
                        	<input type="radio" class="btn_radio_rating<?php echo $i; ?>" name="btn_radio_rating<?php echo $i; ?>" value="3" <?php echo  set_radio('btn_radio_rating'.$i, '3', $value['tlhr_rating_number'] == '3'); ?> disabled />
                        </label>
                        <label class="btn btn-default option agree med <?php if(@$tlhr_rating_number== 2){echo $active_class;} ?>" >
                            <input type="radio" class="btn_radio_rating<?php echo $i; ?>" name="btn_radio_rating<?php echo $i; ?>" value="2" <?php echo  set_radio('btn_radio_rating'.$i, '2', $value['tlhr_rating_number'] == '2'); ?>  />
                        </label>
                        <label class="btn btn-default option agree min <?php if(@$tlhr_rating_number== 1){echo $active_class;} ?>" >
                            <input type="radio" class="btn_radio_rating<?php echo $i; ?>" name="btn_radio_rating<?php echo $i; ?>" value="1" <?php echo  set_radio('btn_radio_rating'.$i, '1', $value['tlhr_rating_number'] == '1'); ?> />
                        </label>
                        <label class="btn btn-default option neutral <?php if(@$tlhr_rating_number== 0){echo $active_class;} ?>" >
                            <input type="radio" class="btn_radio_rating<?php echo $i; ?>" name="btn_radio_rating<?php echo $i; ?>" value="0" <?php echo  set_radio('btn_radio_rating'.$i, '0', $value['tlhr_rating_number'] == '0'); ?>  />
                        </label>
                        ...
                        <label class="btn btn-default option disagree max <?php if(@$tlhr_rating_number== -3){echo $active_class;} ?>" >
                            <input type="radio" class="btn_radio_rating<?php echo $i; ?>" name="btn_radio_rating<?php echo $i; ?>" value="-3" <?php echo  set_radio('btn_radio_rating'.$i, '-3', $value['tlhr_rating_number'] == '-3'); ?>  />
                        </label>
                    </div>
