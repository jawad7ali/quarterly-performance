...
<a href="<?php echo base_url(); ?>factors/lead_to_hr" class="btn btn-primary btn-sm btn-tlhr-rating">Start Evaluation</a>
	  ...
	  <tbody>
	  	<?php $i=1; foreach ($evaluate_list as $key => $value): ?>
	  		<tr>  			
	  			...
	  			<td><?php echo $value['tlhr_designation']; ?></td>
	  			<td><?php echo $value['tlhr_department']; ?></td>
	  			<td><?php echo $value['tlhr_project']; ?></td>
