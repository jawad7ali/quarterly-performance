...
<a href="<?php echo base_url(); ?>rating/evaluate_ltm" class="btn btn-primary btn-sm btn-tlhr-rating">Start Evaluation</a>
<?php } ?>
	  ...
	  <tbody>
	  	<?php $i=1; foreach ($evaluate_list as $key => $value): ?>
	  		<tr>  			
	  			...
	  			<td>
	  			<a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>rating/evaluate_ltm/<?php echo $value['tlm_name']. '/'. $value['tlm_id']; ?>">Edit</a>	
