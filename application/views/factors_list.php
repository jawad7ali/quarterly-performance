...
<a href="<?php echo base_url(); ?>factors/add/<?php echo $this->uri->segment('3') ?>" class="btn btn-primary btn-sm btn-tlhr-eval">Add Evaluation Factor</a>
	  ...
	  <tbody>
	  	<?php $i=1; foreach ($factors_list as $key => $value): ?>
	  		<tr>
	  			...
	  			<td class="actions">
	  			<a class="btn btn-info btn-xs" href="<?php echo base_url(); ?>factors/add/<?php echo @$value['fac_id']; ?>">Edit</a>
